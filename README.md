...
このリポジトリでは、**Stardew Valley** に関する個人制作の翻訳MODを公開しています。  
趣味の延長で制作しており、**英語の勉強をかねつつ、登場人物の雰囲気や言葉のニュアンスを大事にしながら**訳しています。  
専門用語やスラングの理解には、AIツールや辞書サイトなども活用しています📚  
初学者なため、誤訳や不自然な文章もあります…。どうかご理解いただけると幸いです。
翻訳ファイルは自己責任でご利用ください。
...
If the original MOD author requests that a translation be removed or distribution stopped,  
we will promptly respond and take the necessary steps with full respect for your rights.
